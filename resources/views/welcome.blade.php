                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                                    <a
                                        href="{{ route('dashboard-unauthenticated') }}"
                    ...
                    <main class="mt-6">
                        <div class="text-center pb-8">
                            <h1 class="text-4xl font-extrabold text-gray-900 mb-6">Welcome to Our Clothing Store!</h1>
                            <p class="text-lg text-gray-700 mb-8">Explore our latest collection of trendy clothes and accessories.</p>
