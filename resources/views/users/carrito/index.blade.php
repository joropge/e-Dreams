                                ...
                                <tr>
                                    <td class="flex items-center gap-2 px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                        <div class="w-20 h-20 overflow-hidden rounded-2xl">
                                            <img src="{{ Storage::url('public/' . $rutaDeseada) }}" alt="{{ $producto->nombre }}" class="object-cover w-full h-full">
                                        </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
                                        <div class="relative">
                                            <input type="number" name="cantidad" value="{{ $carrito->cantidad }}" min="0" class="w-16 text-center appearance-none border rounded-md py-1 px-3 bg-gray-100" oninput="this.value = Math.max(this.value, 0)" onchange="updateCantidad({{ $carrito->id }}, this.value)">
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-sm leading-5">
