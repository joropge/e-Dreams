@if(\Session::get("success"))
    <div id="success-msg" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded fixed top-5 right-5 w-64 shadow-lg transform transition-transform translate-x-full" role="alert">
